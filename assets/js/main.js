...
setTimeout(() => {
  (function () {
    ...
    const on = (type, el, listener, all = false) => {
      ...
      if (selectEl) {
        if (all) {
          selectEl.forEach(e => $(e).off(type).on(type, listener))
        } else {
    ...
    if (portfolioContainer) {
      ...
      on('click', '#portfolio-flters li', function (e) {
        ...
        if (dataFilter == "*") {
          $(".portfolio-item").addClass("hideFilter");
          for (let i = 0; i < 6; i++) {
            $(".portfolio-item").eq(i).removeClass("hideFilter");
          }
        } else {
          $(".portfolio-item").addClass("hideFilter");
          $(".portfolio-item" + dataFilter).removeClass("hideFilter");
        }
